...
<head>
  <meta charset="utf-8">
  <title>Filmes - Mundo das Telas</title>
  <link rel="stylesheet" href="css/crud.css">
</head>
<body>
  <h1>Filmes</h1>
  <p><a href="filmes_inserir.php">Adicionar novo filme</a> | <a href="Inicio.php">Voltar</a></p>
    ...
    <table border="1" cellpadding="6">
      ...
      <?php foreach($filmes as $f): ?>
        <tr>
          ...
          <td>
            <a href="filmes_gerenciar.php?id=<?php echo $f['id']; ?>">Ver</a> |
