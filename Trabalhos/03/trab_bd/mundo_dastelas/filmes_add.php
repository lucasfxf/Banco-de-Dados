...
<!doctype html>
<html>
<head><meta charset="utf-8"><title>Adicionar Filme</title><link rel="stylesheet" href="css/crud.css"></head>
<body>
  <h1>Adicionar Filme</h1>
  <?php if (!empty($error)): ?><p style="color:red;"><?php echo htmlspecialchars($error); ?></p><?php endif; ?>
  <form method="post" action="filmes_add.php">
    <label>Nome: <input type="text" name="nome" required></label><br>
    <label>Descrição:<br><textarea name="descricao" rows="4" cols="60" required></textarea></label><br>
  ...
  <p><a href="filmes.php">Voltar à lista</a></p>
</body>
</html>
